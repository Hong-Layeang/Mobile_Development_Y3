...
const String diceImage1 = 'assets/dice-1.png';
const String diceImage3 = 'assets/dice-3.png';
const String diceImage5 = 'assets/dice-5.png';
const String diceImage6 = 'assets/dice-6.png';
...
class _DiceRollerState extends State<DiceRoller> {
  ...
  void rollDice() {
    setState(() {
      var diceNum = Random().nextInt(6) + 1; // shifts the range by 1. so: 1 -> 6
      switch(diceNum) {
        case 1: 
